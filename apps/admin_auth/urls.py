...
urlpatterns = [
    ...
    path('hotels/<int:property_id>/room-types/', AdminHotelRoomTypesView.as_view(), name='admin-hotel-room-types'),
    ...
    path('hotels/<int:property_id>/bookings/create/', AdminHotelBookingCreateView.as_view(), name='admin-hotel-booking-create'),
    path('hotels/<int:property_id>/bookings/<int:booking_id>/', AdminHotelBookingDetailView.as_view(), name='admin-hotel-booking-detail'),
    path('hotels/<int:property_id>/bookings/<int:booking_id>/accept/', AdminHotelBookingAcceptView.as_view(), name='admin-hotel-booking-accept'),
    path('hotels/<int:property_id>/bookings/<int:booking_id>/cancel/', AdminHotelBookingCancelView.as_view(), name='admin-hotel-booking-cancel'),
    path('hotels/<int:property_id>/bookings/<int:booking_id>/check-in/', AdminHotelBookingCheckInView.as_view(), name='admin-hotel-booking-check-in'),
    path('hotels/<int:property_id>/bookings/<int:booking_id>/check-out/', AdminHotelBookingCheckOutView.as_view(), name='admin-hotel-booking-check-out'),
    path('hotels/<int:property_id>/bookings/<int:booking_id>/move/', AdminHotelBookingMoveView.as_view(), name='admin-hotel-booking-move'),
    path('hotels/<int:property_id>/rates/', AdminHotelRatesView.as_view(), name='admin-hotel-rates'),
