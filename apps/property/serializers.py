...
class PropertyServiceListSerializer(serializers.Serializer):
    ...
    category_key = serializers.CharField(required=False, allow_null=True)


class PrefectureDistrictListSerializer(serializers.Serializer):
...
class PrefectureListSerializer(serializers.Serializer):
    guid = serializers.UUIDField()
    title = serializers.CharField()
    district = PrefectureDistrictListSerializer(allow_null=True)
