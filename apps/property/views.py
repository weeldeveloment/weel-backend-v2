...
class PropertyListCreateView(APIView):
    ...
    @swagger_auto_schema(
        ...
        operation_description="Returns verified public apartments and cottages. Use `property_type` or `kind` to filter to one property kind. `X-Testing-Mode: true` returns only testing properties; otherwise testing properties are excluded.",
        tags=["Property / Public"],
        manual_parameters=PROPERTY_LIST_QUERY_PARAMS + [TESTING_MODE_HEADER_PARAM],
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Default: return apartments and cottages (mixed list)
        apt_rows = _list_apartment_rows(
...
class AdminAllPropertiesListView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        total = len(apt_rows) + len(cot_rows)
        data = (
